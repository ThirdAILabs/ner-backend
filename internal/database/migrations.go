...
func GetMigrator(db *gorm.DB) *gormigrate.Gormigrate {
	...
	migrator.InitSchema(func(txn *gorm.DB) error {
		...
		return db.AutoMigrate(
			&Model{}, &ModelTag{}, &Report{}, &ReportTag{}, &CustomTag{}, &ShardDataTask{}, &InferenceTask{}, &Group{}, &ObjectGroup{}, &ObjectEntity{}, &ReportError{}, &ObjectPreview{}, &ChatHistory{}, &ChatSession{}, &UploadFilePath{},
		)
	})
