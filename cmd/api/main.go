...
type APIConfig struct {
	...
	ModelType         string `env:"MODEL_TYPE" envDefault:"onnx_cnn"`
}
...
func main() {
	...
	// Load NER model for chat service
	loaders := core.NewModelLoaders()
	nerModel, err := loaders[core.ParseModelType(cfg.ModelType)](cfg.HostModelDir)
	if err != nil {
