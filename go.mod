...
require (
	...
	github.com/knights-analytics/hugot v0.3.6
...
require (
	...
	github.com/gomlx/go-huggingface v0.1.2 // indirect
	github.com/gomlx/gomlx v0.18.0 // indirect
	github.com/gomlx/gopjrt v0.6.3 // indirect
