...
export async function retrainTokenClassifier({
  ...
  console.log(
    `Mock: Retraining token classifier with model_name: ${model_name}, base_model_id: ${base_model_id}`
  );
...
export function trainUDTWithCSV({
  ...
  console.log(
    `Mock: Training UDT with CSV - model_name: ${model_name}, base_model_identifier: ${base_model_identifier}, test_split: ${test_split}`
  );
...
export async function getLabels(): Promise<string[]> {
  ...
  return ['NAME', 'PHONE', 'EMAIL', 'ADDRESS', 'DATE', 'ORGANIZATION', 'LOCATION', 'O'];
}
